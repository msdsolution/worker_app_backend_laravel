...
<!-- <td>
                <input type="checkbox" role="switch" class="toggle-class" data-id="{{ $item->id }}" data-toggle="toggle" data-style="slow" data-on="Verified" data-off="Not Verified" {{ $item->status == true ? 'checked' : '' }}>
              </td> -->