...
Route::get('/privacy-policy', [App\Http\Controllers\ApiController::class, 'privacy_policy'])->name('privacy-policy');
Route::get('/terms_and_condition', [App\Http\Controllers\ApiController::class, 'terms_and_condition'])->name('terms-and-condition');
